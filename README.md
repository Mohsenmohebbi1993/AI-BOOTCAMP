...
AI Bootcamp: A 6-month intensive program covering Python programming, Artificial Intelligence models, Computer Vision, and more
...
│                         ai_bootcamp and configuration for tools like black
│
...
│
└── ai_bootcamp   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes ai_bootcamp a Python module
    │
